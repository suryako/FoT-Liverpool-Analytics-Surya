...
def plot_pitchcontrol_for_liverpool(tracking_home, tracking_away, xgrid, ygrid, pass_frame, PPCF, alpha = 0.7, include_player_velocities=True, annotate=False, field_dimen = (106.0,68), output_mode='plot'):
    """ plot_pitchcontrol_for_event( event_id, events,  tracking_home, tracking_away, PPCF, xgrid, ygrid )
    ...
    # pick a pass at which to generate the pitch control surface
    pass_team = 'Home' # events.loc[event_id].Team # always liverpool in our case, attacking team
